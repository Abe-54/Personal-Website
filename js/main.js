...
function typing_animation() {
    let text_element = document.querySelector(".hero__tagline__text");
    let text_array = text_element.innerHTML.split("");
    let text_array_slice = text_element.innerHTML.split(" ");

    // let text_array = ["web", "developer", " ", "game", "creator", " ", "programmer"];
    ...
    document.querySelector(".hero__tagline__text_cursor").animate([
        {
            opacity: 0
        },
        {
    ...
    if (text_array_slice.length == 1) {
        ...
        let reveal_animation = document.querySelector(".hero__tagline__text_hide").animate([
            { left: '0%' },
        ...
        reveal_animation.onfinish = () => {
            setTimeout(() => {
                document.querySelector('.hero__tagline__text_hide').animate([
                    {left: '0%'}
                ], {
                    duration: 2000,
